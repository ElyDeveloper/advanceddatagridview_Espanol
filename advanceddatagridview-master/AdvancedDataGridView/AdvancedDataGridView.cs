...
namespace Zuby.ADGV
{
    ...
    public class AdvancedDataGridView : DataGridView
    {
        ...
        public static Dictionary<string, string> Translations = new Dictionary<string, string>()
        {
          ...
          {
            AdvancedDataGridView.TranslationKey.ADGVSortBoolASC.ToString(),
            "Ordenar por falso / verdadero"
          },
          {
            AdvancedDataGridView.TranslationKey.ADGVSortBoolDESC.ToString(),
            "Ordenar por verdadero / falso"
          },
          {
            AdvancedDataGridView.TranslationKey.ADGVSortNumASC.ToString(),
            "Ordenar más pequeño a más grande"
          },
          {
            AdvancedDataGridView.TranslationKey.ADGVSortNumDESC.ToString(),
            "Ordenar más grande a más pequeño"
          },
          {
            AdvancedDataGridView.TranslationKey.ADGVSortTextASC.ToString(),
            "Ordenar А a Z"
          },
          {
            AdvancedDataGridView.TranslationKey.ADGVSortTextDESC.ToString(),
            "Ordenar Z a A"
          },
          {
            AdvancedDataGridView.TranslationKey.ADGVAddCustomFilter.ToString(),
            "Agregar Filtro Personalizado"
          },
          {
            AdvancedDataGridView.TranslationKey.ADGVCustomFilter.ToString(),
            "Filtro personalizado"
          },
          {
            AdvancedDataGridView.TranslationKey.ADGVClearFilter.ToString(),
            "Limpiar Filtro"
          },
          {
            AdvancedDataGridView.TranslationKey.ADGVClearSort.ToString(),
            "Borrar Ordenar"
          },
          {
            AdvancedDataGridView.TranslationKey.ADGVButtonFilter.ToString(),
            "Filtrar"
          },
          {
            AdvancedDataGridView.TranslationKey.ADGVButtonUndofilter.ToString(),
            "Cancelar"
          },
          {
            AdvancedDataGridView.TranslationKey.ADGVNodeSelectAll.ToString(),
            "(Seleccionar Todo)"
          },
          {
          ...
          {
            AdvancedDataGridView.TranslationKey.ADGVNodeSelectTrue.ToString(),
            "Verdadero"
          },
          {
            AdvancedDataGridView.TranslationKey.ADGVNodeSelectFalse.ToString(),
            "Falso"
          },
          {
            AdvancedDataGridView.TranslationKey.ADGVFilterChecklistDisable.ToString(),
            "La lista de filtros está deshabilitada"
          },
          {
            AdvancedDataGridView.TranslationKey.ADGVEquals.ToString(),
            "Igual"
          },
          {
          ...
          {
            AdvancedDataGridView.TranslationKey.ADGVInvalidValue.ToString(),
            "Valor inválido"
          },
          {
            AdvancedDataGridView.TranslationKey.ADGVFilterStringDescription.ToString(),
            "Mostrar filas donde el valor {0} \"{1}\""
          },
          {
            AdvancedDataGridView.TranslationKey.ADGVFormTitle.ToString(),
            "Filtro personalizado"
          },
          {
            AdvancedDataGridView.TranslationKey.ADGVLabelColumnNameText.ToString(),
            "Mostrar filas donde el valor"
          },
          {
            AdvancedDataGridView.TranslationKey.ADGVLabelAnd.ToString(),
            "Y"
          },
          {
            AdvancedDataGridView.TranslationKey.ADGVButtonOk.ToString(),
            "OK"
          },
          {
            AdvancedDataGridView.TranslationKey.ADGVButtonCancel.ToString(),
            "Cancelar"
          }
        };
